...
public class TinkEncDec {
    ...
    //@Value("${tink.key128Bit}")=>application.propertiesin içinde bir data varsa datanın application.properties den koparılıp java içinde kullanılmasını istediğimizde @value kullanırız
    ...
    public String encrypt( String plainText ) {
        // plainText => şifrelemek istediğimiz datadır  plainText ile üretilen data taşınbiliyor olması lazım
        String cipherText = "";
        try {
